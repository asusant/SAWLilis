                  ...
                  <div class="card">
                    <div class="card-header bg-info"><h4 class="m-b-0 text-white">Nilai Kriteria: {{ $kriteria->kriteria }}</h4>
                      ...
                      <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/nilai-kriteria') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('NilaiKriteria::nilai-kriteria.form', ['formMode' => 'create'])
