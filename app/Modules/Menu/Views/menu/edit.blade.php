  ...
  <div class="page-wrapper">
      ...
      <div class="container-fluid">
          ...
          <div class="row page-titles">
              ...
              <div class="col-md-7 align-self-center text-right">
                  <div class="d-flex justify-content-end align-items-center" style="display:inline-flex!important">
                      ...
                      <a href="{{ url('/menu') }}" class="btn btn-info m-l-15"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancel</a>
                  </div>
              </div>
          </div>
          <!-- ============================================================== -->
          ...
          <div class="row justify-content-md-center">
              <div class="col-12">
                  <div class="card">
                    <div class="card-header bg-info"><h4 class="m-b-0 text-white">Edit Menu #{{ $menu->id }}</h4>
                    </div>
                      <div class="card-body">
                        @if ($errors->any())
