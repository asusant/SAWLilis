      ...
      <div class="container-fluid">
          ...
          <div class="row page-titles">
              <div class="col-md-5 align-self-center">
                  <h4 class="text-themecolor">Edit Evaluasi </h4>
              </div>
              <div class="col-md-7 align-self-center text-right">
                  <div class="d-flex justify-content-end align-items-center" style="display:inline-flex!important">
                      ...
                      <a href="{{ url('/evaluasi') }}" class="btn btn-info m-l-15"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancel</a>
                  </div>
              </div>
          </div>
          <!-- ============================================================== -->
                    ...
                    <div class="card-header bg-info"><h4 class="m-b-0 text-white">Edit Evaluasi #{{ $evaluasi['alternatif']->alternatif }}</h4>
                      ...
                      <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/evaluasi/' . $evaluasi['alternatif']->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            @include ('Evaluasi::evaluasi.form', ['formMode' => 'edit'])
