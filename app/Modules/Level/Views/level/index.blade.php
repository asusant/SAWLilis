      ...
      <div class="container-fluid">
          ...
          <div class="row page-titles">
              <div class="col-md-5 align-self-center">
                  <h4 class="text-themecolor">Level </h4>
              </div>
              <div class="col-md-7 align-self-center text-right">
                  <div class="justify-content-end align-items-center" style="display:inline-flex!important">
                      ...
                      <a href="{{ url('/level/create') }}" class="btn btn-info {{--d-none d-lg-block--}} m-l-15"><i class="fa fa-plus-circle"></i> Create New Level</a>
                  </div>
              </div>
          </div>
          <!-- ============================================================== -->
                              ...
                              <table id="main-table" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                      <tr>
                                          ...
                                          <th>Level</th><th>Icon</th><th>Description</th>
